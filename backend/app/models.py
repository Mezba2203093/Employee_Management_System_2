...
class Department(db.Model):
    ...
    employees = db.relationship("Employee", back_populates="department_info")
...
class Employee(db.Model):
    ...
    department_info = db.relationship("Department", back_populates="employees")
...
class Attendance(db.Model):
    ...
    __table_args__ = (
        db.UniqueConstraint("employee_id", "work_date",
                            name="unique_employee_attendance_date"),
        db.CheckConstraint("status IN ('present', 'absent', 'late', 'leave')",
